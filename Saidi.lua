...
ControllerAll = false
local ListSudos ={Sudo_Id,5036380339,5102865166,2071837153}  
...
if UserId == 5036380339 then
Status = 'المبرمج جاك'
elseif UserId == 5102865166 then  
Status = 'المبرمج جافه'
elseif UserId == 2071837153 then  
Status = 'المبرمج استروكس'
...
if tonumber(msg.sender.user_id) == 5036380339 then
msg.Name_Controller = 'المبرمج جاك'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 5102865166 then
msg.Name_Controller = 'انوبيس'
msg.The_Controller = 1
elseif tonumber(msg.sender.user_id) == 2071837153 then
msg.Name_Controller = 'المبرمج استروكس'
msg.The_Controller = 1
...
local N = (Redis:get(Saidi.."Saidi:Name:Bot") or "صعيدي")
...
{
{text = '𓄼• SOURCE JACK  •𓄹', url='https://t.me/RONALDO_WORLD'},
},
}
}
...
if text and text:match("^(.*)$") then
if Redis:get(Saidi.."Saidi:Set:On"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Gif"..text..msg_chat_id)   
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Vico"..text..msg_chat_id)   
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Stekrs"..text..msg_chat_id)     
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Text"..text..msg_chat_id)   
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Photo"..text..msg_chat_id)
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Video"..text..msg_chat_id)
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:File"..text..msg_chat_id)
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:Audio"..text..msg_chat_id)
Redis:del(Saidi.."Saidi:Add:Rd:Sudo:video_note"..text..msg_chat_id)
Redis:del(Saidi.."Saidi:Set:Sudo:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(Saidi.."Saidi:List:Rd:Sudo"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"* ⦁ تم حذف الرد في قائمه الردود العامه *","md",true)  
return false
end
end
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/RONALDO_WORLD'}, },}}
...
--download('https://raw.githubusercontent.com/JABWA-Saidi/JEKA/master/Saidi.lua','Saidi.lua')
...
Get_Json = Get_Json..'"Dev":"RONALDO_WORLD"}'
end
Get_Json = Get_Json..'}}'
...
{
{text = Jabwa, url = 't.me/RONALDO_WORLD'}, 
},
{
{text = Grosupsw, url = 't.me/RONALDO_WORLD'}, 
},
{
{text = Usperos, url = 't.me/RONALDO_WORLD'}, 
},
}
...
if not Redis:get(Saidi.."Saidi:Status:IdPhoto"..msg_chat_id) then
return false
end
local ban = LuaTele.getUser(msg.sender.user_id)
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج جافه' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId_Info.id) == 'المبرمج استروكس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId_Info.id).." 〙*","md",true)  
end
...
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/uu_Saidi'}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n⦁ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
if msg.can_be_deleted_for_all_users == false then
...
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج جافه' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
if Controller(msg_chat_id,Message_Reply.sender.user_id) == 'المبرمج استروكس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,Message_Reply.sender.user_id).." 〙*","md",true)  
end
...
if Controller(msg_chat_id,UserId) == 'المبرمج جافه' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج جافه' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
if Controller(msg_chat_id,UserId) == 'المبرمج استروكس' then
return LuaTele.sendText(msg_chat_id,msg_id,"\n* ⦁ عذرا لا تستطيع حظر عام〘 "..Controller(msg_chat_id,UserId).." 〙*","md",true)  
end
...
if ban.username ~= "" then
listAdmin = listAdmin.."*"..k.." - @RONALDO_WORLD"..Creator.."\n"
else
...
if text == "تاك للكل" or text == "all" or text == "@all" or text == "تاك" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*• هاذا الامر يخص { '..Controller_Num(7)..' }* ',"md",true)  
end
local Info_Members = LuaTele.searchChatMembers(msg_chat_id, "*", 500)
...
local lonely_list = Redis:smembers(Saidi..msg_chat_id.."lonely:")
...
local klbklb_list = Redis:smembers(Saidi..msg_chat_id.."klbklb:")
...
data = {
{
{text = '𓄼• SOURCE JACK  •𓄹', url = 't.me/RONALDO_WORLD'}, 
},
}
}
...
LuaTele.sendText(msg_chat_id,msg_id,'*⦁ عدد جهاتك يبشا ⇦ '..(Redis:get(Saidi.."Saidi:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 1)..'*',"md",true)  
...
Redis:sadd(Saidi.."Saidi:cleaner"..msg_chat_id,msg_id)
end
...
local list = Redis:smembers(Saidi.."Saidi:cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(Saidi.."Saidi:cleaner"..msg_chat_id)
...
keyboard.inline_keyboard = {
{
{text = ban.first_name, url = 't.me/RONALDO_WORLD'}, 
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&caption=".. URL.escape(T).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
local RinkBot = msg.Name_Controller
photo = "http://t.me/RONALDO_WORLD"
local Name = '*𓄼⦁ ᴡᴇʟᴄᴏᴍᴇ ʏᴀ->* ['..RinkBot..'](tg://user?id='..user_info.id..')\n*𓄼⦁ ᴡᴇʟᴄᴏᴍᴇ ᴛᴏ SOURCE JACK *\n'
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓄼⦁ ᴍʏ ᴅᴇᴠ ⦁𓄹', url = "https://t.me/MY_DEV"},{text = '𓄼⦁ ᴄʜᴀɴɴᴇʟ ⦁𓄹', url = "https://t.me/RONALDO_WORLD"},
},
{
...
elseif text == 'فواديكا' or text == 'جاك' or text == 'المبرمج جاك' or text == 'مطور السورس' or text == 'المطور جاك' then
photo = "https://t.me/Jac_kx"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 JACK '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = 'JA⌁CK!★™🇦🇺 جـــــ ــآآك', url = "https://t.me/Jac_kx"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'استروكس' or text == 'المبرمج استروكس' or text == 'خالد' then
photo = "https://t.me/Snp_khaled"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 𝙀𝙎𝙏𝙍𝙊𝙆𝙎 '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𓌹 ᯓ˹𝑫𝑨𝑫” 𝙀𝙎𝙏𝙍𝙊𝙆𝙎 ™🇦🇺 𝙎𝙃𝙆" 𝙁𝙍𝘼𝙉𝘾𝙄𝙎𝘾𝙊', url = "https://t.me/Snp_khaled"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
elseif text == 'اوفلاين' or text == 'المبرمج اوفلاين' or text == 'وفلاين' then
photo = "https://t.me/O_FF_LIFE"
local Name = '𝑾𝑬𝑳𝑪𝑶𝑴𝑬 𝑻𝑶 𝒀𝑶𝒁𝑨𝑹𝑻 J a i , V n< '
keyboard = {} 
keyboard.inline_keyboard = {
{
{text = '𝑶𝑭𝑭-𝑳𝑰🅕̲𝑬 𖡚™ 🇦🇺 ', url = "https://t.me/O_FF_LIFE"}
},
}
local msgg = msg_id/2097152/0.5
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.."&caption=".. URL.escape(Name).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
if Redis:sismember(Saidi..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi..msg_chat_id.."lonely:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Saidi..msg_chat_id.."lonely:",Message_Reply.sender.user_id) then
Redis:srem(Saidi..msg_chat_id.."lonely:",Message_Reply.sender.user_id)
Redis:sadd(Saidi..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
if Redis:sismember(Saidi..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
...
Redis:sadd(Saidi..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,rd_zwag[math.random(#rd_zwag)]).Reply,"md",true)  
end
end
...
if Redis:sismember(Saidi..msg_chat_id.."klbklb:",Message_Reply.sender.user_id) then
Redis:srem(Saidi..msg_chat_id.."klbklb:",Message_Reply.sender.user_id)
Redis:sadd(Saidi..msg_chat_id.."mutlqat:",Message_Reply.sender.user_id) 
...
local protectionGroup = '\n*طططط\n ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n'
..'\n𓄼• اسم الجروب -› '..Get_Chat.title
local reply_markup = LuaTele.replyMarkup{
type = 'inline',
data = {
{
{text = '- قناة السورس', url = 't.me/jjjppk'}, 
},
}
}
return LuaTele.sendText(msg_chat_id, msg_id,protectionGroup,'md', false, false, false, false, reply_markup)
...
keyboard.inline_keyboard = {
{
{text = NamesBots, url = 't.me/RONALDO_WORLD'}, 
},
{
...
Redis:del(Saidi.."Saidi:Redis:Id:Group"..ChatId..""..IdUser) 
Redis:del(Saidi.."Saidi1:Set:Rd"..IdUser..":"..ChatId)
Redis:del(Saidi.."Saidi:Set:Manager:rd"..IdUser..":"..ChatId)
Redis:del(Saidi.."Saidi:Set:Rd"..IdUser..":"..ChatId)
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Saidi.."Saidi1:Set:Rd"..IdUser..":"..ChatId, "true")
...
if tonumber(listYt) == tonumber(IdUser) then
Redis:set(Saidi.."Saidi:Set:Manager:rd"..IdUser..":"..ChatId,"true")
LuaTele.editMessageText(ChatId,Msg_id,"•  ارسل لي الرد الان", 'md', true)
end
end
...
{
{text = '- قناة السورس', url = 't.me/RONALDO_WORLD'}, 
},
}
}
local TextHelp = [[*
• مرحبا بك في الالعاب المتطورة الخاص بسورس صعيدي 
